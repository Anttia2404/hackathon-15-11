...
export function SmartStudy() {
  ...
  const handleAnalyze = async () => {
    ...
    try {
      const result = await quizService.analyzeFile(
        file,
      ...
      setError(
        err.response?.data?.message || "Có lỗi xảy ra khi phân tích file"
      );
      setStep("upload");
    } finally {
      setLoading(false);
      ...
      <div className="container mx-auto px-4 max-w-6xl relative z-10">
        ...
        >
          ...
          <p className="text-gray-600">
            Upload tài liệu → Nhận tóm tắt AI → Tạo quiz tự động → Ôn tập thông
            minh
          </p>
        </motion.div>
                    ...
                    >
                      ...
                      >
                        ...
                        <div className="absolute inset-0 backface-hidden">
                          <Card className="h-full p-4 flex flex-col items-center justify-center bg-gradient-to-br from-indigo-50 to-purple-50 border-2 border-indigo-200">
                        ...
                        <div className="absolute inset-0 backface-hidden rotate-y-180">
                          <Card className="h-full p-4 flex flex-col items-center justify-center bg-gradient-to-br from-green-50 to-emerald-50 border-2 border-green-200">
                            <div className="text-center space-y-4">
                              ...
                              <div className="space-y-3">
                                ...
                                <p className="text-2xl font-bold text-gray-900">
                                  {
                                    questions[currentCardIndex]?.options[
                                      questions[currentCardIndex]?.correctAnswer
                                    ]
                                  }
                                </p>
