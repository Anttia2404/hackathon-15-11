  ...
  const generatedQuestions = [
    {
      ...
      correctAnswer: 1,
      explanation: 'Machine Learning là nhánh của AI tập trung vào việc xây dựng các thuật toán có khả năng học từ dữ liệu và cải thiện hiệu suất theo thời gian.'
    },
    {
      ...
      correctAnswer: 1,
      explanation: 'Supervised Learning cần dữ liệu được gán nhãn để model có thể học mối quan hệ giữa input và output.'
    },
    {
      ...
      correctAnswer: 1,
      explanation: 'Neural Network mô phỏng cấu trúc và cách hoạt động của các tế bào thần kinh trong não người.'
    },
    {
      ...
      correctAnswer: 0,
      explanation: 'Overfitting xảy ra khi model học quá chi tiết từ training data, bao gồm cả nhiễu, dẫn đến hiệu suất kém trên dữ liệu mới.'
    },
    {
      ...
      correctAnswer: 1,
      explanation: 'Regularization là kỹ thuật thêm penalty vào loss function để tránh model học quá phức tạp, giúp giảm overfitting.'
    }
  ];
    ...
    <div className="min-h-screen bg-gray-50 py-8">
      <div className="container mx-auto px-4 max-w-6xl">
        ...
        >
          ...
          <p className="text-gray-600">Tạo bài kiểm tra tự động bằng AI, tiết kiệm thời gian cho giảng viên</p>
        </motion.div>
          ...
          >
            {!generated ? (
              <Card className="p-12 text-center">
                ...
                <h3 className="mb-2 text-gray-900">Sẵn sàng tạo bài kiểm tra?</h3>
                <p className="text-gray-600 mb-6">
                  Điền thông tin bên trái và nhấn "Generate" để AI tạo câu hỏi tự động
                </p>
                      ...
                      <div className="flex items-start justify-between mb-4">
                        <div className="flex items-start gap-3 flex-1">
                          ...
                          <div className="flex-1">
                            <div className="text-gray-900 mb-4">{q.question}</div>
                            ...
                            <div className="p-4 bg-blue-50 rounded-lg">
                              <div className="flex items-start gap-2">
                                ...
                                <div>
                                  <div className="text-blue-700 mb-1">Giải thích</div>
