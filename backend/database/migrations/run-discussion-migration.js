...
async function runDiscussionMigration() {
  try {
    ...
    await sequelize.query(`
      ...
      CREATE INDEX IF NOT EXISTS idx_discussions_pin ON discussions(pin_code);
      ...
      CREATE INDEX IF NOT EXISTS idx_responses_discussion ON discussion_responses(discussion_id);
      CREATE INDEX IF NOT EXISTS idx_responses_student ON discussion_responses(student_id);
      CREATE INDEX IF NOT EXISTS idx_responses_upvotes ON discussion_responses(upvotes DESC);
    `);
