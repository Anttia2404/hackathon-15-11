// Simple script to create Study Room tables
// Run with: node create-study-room-tables.js
...
async function createTables() {
  ...
  try {
    ...
    console.log('   - study_room_participants');
    console.log('   - study_room_goals');
    console.log('   - study_room_invitations');
